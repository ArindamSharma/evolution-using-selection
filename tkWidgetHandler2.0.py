    ...
    def set_img(self,file_path,size="medium")->tk.PhotoImage:
        ...
        try:
            ...
            try:
                ...
                if(size=="small"):
                    self.img[image_name]["small"]=self.img[image_name]["widget"].subsample(4)
                elif(size=="medium"):
                    self.img[image_name]["medium"]=self.img[image_name]["widget"].subsample(2)
                elif(size=="large"):
                    self.img[image_name]["large"]=self.img[image_name]["widget"].zoom(3).subsample(4)
                elif(size=="root"):
                    return self.img[image_name]["widget"]
                elif(size=="custom"):
                    try:
            ...
            self.img[image_name]["widget"]=tk.PhotoImage(file=file_path)
