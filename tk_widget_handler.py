...
class WidgetHandler:
    ...
    def set_view(self,view_id,**arg)->dict:
        self.__id_exist_check(self.view,view_id)
        self.view[view_id]={}
        self.view[view_id]["widgetType"]="View"
        self.view[view_id]["root"]=tk.Frame(self.root["root"],**arg)
    ...
    def printJson(self,name=None,data=None,indent=4,start_space=" ",space_filler=" "):
        ...
        if (type(data)==type({}) ):
            if(len(data)==0):
                ...
                print(start_space,name," : {")
                for i in data:
                    self.printJson(i,data[i],start_space=tab+start_space,space_filler=space_filler)
                print(start_space,"},")
            ...
            if(len(data)==0):
                ...
                print(start_space,name," : [")
                for i in data:
                    self.printJson("item",i,start_space=tab+start_space,space_filler=space_filler)
                print(start_space,"],")
        else:
